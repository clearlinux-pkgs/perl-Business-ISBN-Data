...
Source0  : https://cpan.metacpan.org/authors/id/B/BD/BDFOY/Business-ISBN-Data-20210112.002.tar.gz
...
%prep
%setup -q -n Business-ISBN-Data-20210112.002
cd %{_builddir}/Business-ISBN-Data-20210112.002
...
cp %{_builddir}/Business-ISBN-Data-20210112.002/LICENSE %{buildroot}/usr/share/package-licenses/perl-Business-ISBN-Data/71a2014618bd8f3f712ddfe79c9da5de5b04e853
if test -f Makefile.PL; then
