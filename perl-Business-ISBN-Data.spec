...
%prep
%setup -q -n Business-ISBN-Data-20191107
cd %{_builddir}/Business-ISBN-Data-20191107
...
cp %{_builddir}/Business-ISBN-Data-20191107/LICENSE %{buildroot}/usr/share/package-licenses/perl-Business-ISBN-Data/71a2014618bd8f3f712ddfe79c9da5de5b04e853
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.28.2/Business/ISBN/Data.pm
/usr/lib/perl5/vendor_perl/5.28.2/Business/ISBN/RangeMessage.url
/usr/lib/perl5/vendor_perl/5.28.2/Business/ISBN/RangeMessage.xml
/usr/lib/perl5/vendor_perl/5.28.2/Business/ISBN/make_data.pl
